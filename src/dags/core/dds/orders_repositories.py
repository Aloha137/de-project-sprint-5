...
# задаем класс для объекта строки
class OrderJsonObj(BaseModel):
    id: int
    object_id: str
    object_value: str

# класс для чтения сырых данных из stg по метке из тех таблицы 
...
# задаем класс для нового объекта строки dds    
...
# создаем класс для заливки данных в dds
...
# получаем нужный order_id из dds
