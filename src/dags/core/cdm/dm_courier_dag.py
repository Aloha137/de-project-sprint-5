...
from core.cdm.dm_courier_loader import  DmCourierLoader 
...
def sprint5_load_cdm_courier():
    ...
    @task()
    def prepare_cdm():
        dm = DmCourierLoader(dwh_pg_connect, log)
        dm.prepare_cdm()
...
load_cdm_dag = sprint5_load_cdm_courier()  # noqa
