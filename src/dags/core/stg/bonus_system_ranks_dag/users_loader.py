...
class UsersObj(BaseModel):
    id: int
    order_user_id: str #in DB text type

class UsersOriginRepository:
    def __init__(self, pg: PgConnect) -> None:
        self._db = pg

    def list_users(self, rank_threshold: int, limit: int) -> List[UsersObj]:
...
class UsersDestRepository:
    ...
    def insert_user(self, conn: Connection, user: UsersObj) -> None:
